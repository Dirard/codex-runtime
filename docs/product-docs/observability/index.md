# Surface Index: Observability

Type: product-docs surface index
Status: synced to implemented working-copy behavior
Owner: docs_writer
Consumer / intended use: release/ops owner, developers, and QA.
Last reviewed: 2026-06-16
Related docs: `docs/product-docs/observability/event-stream-observability.md`
Trace IDs: DOC-OBS-001

## Source Of Truth
Navigation-only map for the observability surface. Owning behavior lives in linked product-docs; this index may list purpose, owners, status links, and gaps without duplicating behavior.

## Surface Purpose
Document observable runtime signals, stream replay diagnostics, and redaction expectations.

## Documents
- `event-stream-observability.md`: current implemented observability behavior for the working-copy baseline.

## Owners
- Release/ops: release_ops_owner.
- QA evidence: qa_engineer.
