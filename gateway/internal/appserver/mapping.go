...
func NewThreadReadParams(threadID string, includeTurns bool) ThreadReadParams {
	return ThreadReadParams{
		ThreadID:     threadID,
		IncludeTurns: includeTurns,
	}
}

func NewThreadTurnsListParams(threadID string, cursor string, limit uint32, sortDirection string, itemsView string) ThreadTurnsListParams {
