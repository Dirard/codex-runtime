...
const (
	...
	ReasonPendingUnavailableAfterRestart     GatewayErrorReason = "pending_unavailable_after_restart"
	...
	ReasonUnknownChat                        GatewayErrorReason = "unknown_chat"
	...
	ReasonIdempotencyScopeMismatch           GatewayErrorReason = "idempotency_scope_mismatch"
	ReasonIdempotencyResultUnavailable       GatewayErrorReason = "idempotency_result_unavailable"
	ReasonIdempotencyUnavailableAfterRestart GatewayErrorReason = "idempotency_unavailable_after_restart"
	ReasonReplayUnavailable                  GatewayErrorReason = "replay_unavailable"
	ReasonReplayOutOfRange                   GatewayErrorReason = "replay_out_of_range"
	ReasonHistoryUnavailable                 GatewayErrorReason = "history_unavailable"
	ReasonChatStateUnavailable               GatewayErrorReason = "chat_state_unavailable"
	...
	ReasonChatRuntimeDisabled                GatewayErrorReason = "chat_runtime_disabled"
	ReasonChatRuntimeNotImplemented          GatewayErrorReason = "chat_runtime_not_implemented"
...
var CanonicalGatewayErrorReasons = []GatewayErrorReason{
	...
	ReasonPendingUnavailableAfterRestart,
	ReasonInvalidEnum,
	...
	ReasonIdempotencyScopeMismatch,
	ReasonIdempotencyResultUnavailable,
	ReasonIdempotencyUnavailableAfterRestart,
	ReasonReplayUnavailable,
	ReasonReplayOutOfRange,
	ReasonHistoryUnavailable,
	ReasonChatStateUnavailable,
	...
	ReasonChatRuntimeDisabled,
	ReasonChatRuntimeNotImplemented,
...
const (
	...
	GatewayErrorCodePermissionDenied   GatewayErrorCode = "permission_denied"
	GatewayErrorCodeFailedPrecondition GatewayErrorCode = "failed_precondition"
	GatewayErrorCodeAborted            GatewayErrorCode = "aborted"
	...
	GatewayErrorCodeOutOfRange         GatewayErrorCode = "out_of_range"
	GatewayErrorCodeUnavailable        GatewayErrorCode = "unavailable"
	GatewayErrorCodeUnknown            GatewayErrorCode = "unknown"
